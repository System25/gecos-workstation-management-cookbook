...
default[:gecos_ws_mgmt][:single_node][:diagnosis_mode_res][:job_ids] = []
default[:gecos_ws_mgmt][:single_node][:diagnosis_mode_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite", "GECOS V3 Lite"]
default[:gecos_ws_mgmt][:single_node][:diagnosis_mode_res][:enable_diagnosis] = false
default[:gecos_ws_mgmt][:single_node][:diagnosis_mode_res][:modification_datetime] = ''
...
default[:gecos_ws_mgmt][:software_mgmt][:appconfig_libreoffice_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite", "GECOS V3 Lite"]
...
default[:gecos_ws_mgmt][:software_mgmt][:appconfig_thunderbird_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite", "GECOS V3 Lite"]
...
default[:gecos_ws_mgmt][:software_mgmt][:appconfig_firefox_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite", "GECOS V3 Lite"]
...
default[:gecos_ws_mgmt][:printers_mgmt][:printers_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite", "GECOS V3 Lite"]
...
default[:gecos_ws_mgmt][:misc_mgmt][:boot_lock_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite", "GECOS V3 Lite", "Ubuntu 14.04.1 LTS"]
...
default[:gecos_ws_mgmt][:misc_mgmt][:tz_date_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite", "GECOS V3 Lite"]
...
default[:gecos_ws_mgmt][:misc_mgmt][:power_conf_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite", "GECOS V3 Lite"]
...
default[:gecos_ws_mgmt][:misc_mgmt][:scripts_launch_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite", "GECOS V3 Lite"]
...
default[:gecos_ws_mgmt][:misc_mgmt][:local_groups_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite", "GECOS V3 Lite"]
...
default[:gecos_ws_mgmt][:misc_mgmt][:local_admin_users_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite", "GECOS V3 Lite"]
...
default[:gecos_ws_mgmt][:misc_mgmt][:cert_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite", "GECOS V3 Lite"]
...
default[:gecos_ws_mgmt][:users_mgmt][:user_apps_autostart_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite", "GECOS V3 Lite"]
...
default[:gecos_ws_mgmt][:users_mgmt][:user_shared_folders_res][:support_os] = ["GECOS V3", "GECOS V2"]
...
default[:gecos_ws_mgmt][:users_mgmt][:web_browser_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite", "GECOS V3 Lite"]
default[:gecos_ws_mgmt][:users_mgmt][:web_browser_res][:ver_threshold] = 4

default[:gecos_ws_mgmt][:users_mgmt][:email_client_res][:users] = {}
default[:gecos_ws_mgmt][:users_mgmt][:email_client_res][:job_ids] = []
default[:gecos_ws_mgmt][:users_mgmt][:email_client_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite", "GECOS V3 Lite"]
...
default[:gecos_ws_mgmt][:users_mgmt][:desktop_background_res][:support_os] = ["GECOS V3", "GECOS V2"]
...
default[:gecos_ws_mgmt][:users_mgmt][:screensaver_res][:support_os] = ["GECOS V3", "GECOS V2"]

default[:gecos_ws_mgmt][:users_mgmt][:user_mount_res][:users] = {}
default[:gecos_ws_mgmt][:users_mgmt][:user_mount_res][:job_ids] = []
default[:gecos_ws_mgmt][:users_mgmt][:user_mount_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite", "GECOS V3 Lite"]
...
default[:gecos_ws_mgmt][:users_mgmt][:folder_sync_res][:support_os] = ["GECOS V3", "GECOS V2"]
...
default[:gecos_ws_mgmt][:users_mgmt][:shutdown_options_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite", "GECOS V3 Lite"]


default[:gecos_ws_mgmt][:users_mgmt][:user_alerts_res][:users] = {}
default[:gecos_ws_mgmt][:users_mgmt][:user_alerts_res][:job_ids] = []
default[:gecos_ws_mgmt][:users_mgmt][:user_alerts_res][:support_os] = ["GECOS V3", "GECOS V2","Gecos V2 Lite", "GECOS V3 Lite"]
